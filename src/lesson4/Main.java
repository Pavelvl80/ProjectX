...
public class Main {
    public static void main(String[] args) {
        ...
        Employee devoloperEmployee1 = new DeveloperEmployee(121, "John", 23, 200, 5, 5, 5);
        Employee devoloperEmployee2 = new DeveloperEmployee(121, "Jinn", 24, 300, 2, 8, 2);
        Employee devoloperEmployee3 = new DeveloperEmployee(121, "Jerry", 25, 400, 1, 8, 1);
