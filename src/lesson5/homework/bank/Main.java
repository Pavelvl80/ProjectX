...
public class Main {
    public static void main(String[] args) {
        ...
        USBank usBank = new USBank(137863, "USA", Currency.USD, 1200, 3000, 150, 10000000);
        EUBank euBank = new EUBank(897567, "EU", Currency.EUR, 900, 2300, 140, 8000000);
        ChinaBank chinaBank = new ChinaBank(543802, "China", Currency.USD, 4000, 1100, 130, 5000000);
